...
class Starbucks:
    def __init__(self, name_coffee):
        self.coffee = name_coffee

    def name_in_coffee(self, name):
        if len(name) >= 9:
            return f'Your {name[0:5]} in {self.coffee}!'
        else:
            return f'Your {name} in {self.coffee}!'

    def __str__(self):
        return f'Choose coffee : {self.coffee}'


amer = Starbucks('Americano')
print(amer)
print(amer.name_in_coffee('Adigggjmggjtkt'))